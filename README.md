...
工作室整套來自 Gaming room，保留房間、桌椅、雙螢幕、主機、鍵鼠、筆電、遊戲機、床與門窗配件。依使用者要求不減面，保留來源法線、UV、Float32 幾何及原尺寸貼圖；僅修正 OBJ 凹多邊形的三角化並排除場外匯出殘件與兩個脫離主體的懸空零件。從 BLEND 原檔恢復四紅、一藍的面光源，取代上一版過強的白色補光。副螢幕、筆電、電視維持黑屏，主螢幕接上既有 BIOS。前一套家具與其來源已移除。
