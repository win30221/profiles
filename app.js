...
async function loadRoomManifest(signal){
  if(window.location?.protocol==='file:'){
    if(window.WorkspaceModelData?.version!==6)await loadClassic('assets/models/room-scene.js?v=20260915-ps5-blue-7');
  ...
  const response=await fetch('assets/models/room-scene.json?v=20260915-ps5-blue-7',{signal});
